...
DEFAULT_WEIGHTS = {
    ...
    "attribute_f1": 0.18,
    "method_f1": 0.08,
    "relation_pair_f1": 0.18,
    "relation_label_f1": 0.08,
    "multiplicity_f1": 0.08,
}
...
def compute_rule_reward(prediction: str, reference: str, weights: dict[str, float] | None = None) -> RuleReward:
    ...
    total -= min(0.20, 0.03 * extra_class_count)
    total -= min(0.20, 0.04 * extra_relation_count)

    if missing_relation_count and class_score.f1 >= 0.8:
