...
from src.utils import RagState, QAAnswerFormat, QAAnswerState, make_chat_openai, invoke_structured_with_retry
...
def build_rag_agent(retriever_tool = None):
    ...
    def generate(state: RagState):
        ...
        # Run
        response = invoke_structured_with_retry(rag_chain, {"context": docs, "question": question}, task_name="rag_generate")
